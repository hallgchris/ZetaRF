...
The default packet size is 8 bytes, but this can be overridden by alternatively calling `beginWithPacketLengthOf(packet_length)`. This can manually be overridden later also. The maximum packet length is 80 bytes.
